...
describe('DefaultPreview', () => {
  ...
  describe('File Type Icons', () => {
    it('should display PDF icon for PDF files', () => {
      ...
      const container = screen.getByTitle(/PDF file/i);
    ...
    it('should display presentation icon for PowerPoint files', () => {
      const file = createMockFile('presentation.pptx', 'application/vnd.openxmlformats-officedocument.presentationml.presentation');
  ...
  describe('Accessibility', () => {
    it('should have proper title attribute with file info', () => {
      ...
      const container = screen.getByTitle('Documents file: important-document.pdf');
      expect(container).toBeInTheDocument();
    });
  ...
  describe('Custom Styling', () => {
    ...
    it('should maintain base styling classes', () => {
      ...
      const previewElement = container.firstChild as HTMLElement;
      expect(previewElement).toHaveClass('relative', 'flex', 'items-center', 'justify-center');
    });
  });
});