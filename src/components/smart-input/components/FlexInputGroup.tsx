  ...
  return (
    <div
      className={cn(
        ...
        // Border and radius - single border around entire group (§1.5: role
        // token, not the generic Tailwind rounded-md)
        'border border-input rounded-btn overflow-hidden',
        ...
        // Unconditional: this is a primary input control, it always gets a
        // visible focus indicator (§1.7 ring-style field), no escape hatch.
