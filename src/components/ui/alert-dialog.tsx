  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          // SETTLE material (§4.5); motion in index.css on the data-slot
          'bg-surface-3 fixed z-50 grid w-full gap-4 p-5 rounded-dialog [box-shadow:var(--edge-machined),var(--shadow-3)]',
          'top-[50%] left-[50%] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] sm:max-w-lg',
          // Bottom sheet below 640px (#46)
